...
public class PurchasedController {
    ...
    public String paymentDone(HttpServletRequest request,@RequestParam String address,@RequestParam String emailid,PurchasedProductsModel pp)
    {
    ...
    public String SearchPurchases(@RequestParam String search,@RequestParam String searchoption,PurchasedProductsModel pp) {
